...
FunctionsToExport = 'Add-PsNetDnsSearchSuffix', 'Add-PsNetHostsEntry', 
               'Clear-PsNetDnsSearchSuffix', 'Get-PsNetAdapterConfiguration', 
               'Get-PsNetAdapters', 'Get-PsNetDnsSearchSuffix', 
               'Get-PsNetHostsTable', 'Get-PsNetRoutingTable', 
               'Remove-PsNetDnsSearchSuffix', 'Remove-PsNetHostsEntry', 
               'Start-PsNetPortListener', 'Test-PsNetDig', 'Test-PsNetPing', 
               'Test-PsNetTping', 'Test-PsNetTracert', 'Test-PsNetUping', 
               'Test-PsNetWping'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/tinuwalther/PsNetTools'
